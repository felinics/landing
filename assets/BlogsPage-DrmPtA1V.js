import{B as e,C as t,D as n,E as r,H as i,J as a,S as o,T as s,Tt as c,X as l,b as u,g as d,nt as f,st as p,x as m,y as h}from"./vue.DKb5ZKVl-qN1CkFl-.js";import{t as ee}from"./arrow-left-CMDPgx1L.js";import{t as g}from"./arrow-right-LszpB-y6.js";import{n as te}from"./vue.6FLi74du-DjYgwyC3.js";import{a as _,c as ne,n as v,o as y,s as re,t as ie}from"./index-B42OFtye.js";var b=_(`calendar-days`,[[`path`,{d:`M8 2v4`,key:`1cmpym`}],[`path`,{d:`M16 2v4`,key:`4m81vk`}],[`rect`,{width:`18`,height:`18`,x:`3`,y:`4`,rx:`2`,key:`1hopcy`}],[`path`,{d:`M3 10h18`,key:`8toen8`}],[`path`,{d:`M8 14h.01`,key:`6423bh`}],[`path`,{d:`M12 14h.01`,key:`1etili`}],[`path`,{d:`M16 14h.01`,key:`1gbofw`}],[`path`,{d:`M8 18h.01`,key:`lrp35t`}],[`path`,{d:`M12 18h.01`,key:`mhygvu`}],[`path`,{d:`M16 18h.01`,key:`kzsmim`}]]),x=_(`clock-3`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6h4`,key:`135r8i`}]]),S=_(`file-text`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`M10 9H8`,key:`b1mrlr`}],[`path`,{d:`M16 13H8`,key:`t4e002`}],[`path`,{d:`M16 17H8`,key:`z1uh3a`}]]),C=_(`user-round`,[[`circle`,{cx:`12`,cy:`8`,r:`5`,key:`1hypcn`}],[`path`,{d:`M20 21a8 8 0 0 0-16 0`,key:`rfgkzh`}]]),w=Object.assign({"../content/blogs/2026-02-16.md":`---
...
`).find(e=>{let t=e.trim();return t&&!t.startsWith(`#`)&&!t.startsWith(`:::`)&&!t.startsWith(`![`)&&!t.startsWith(`- `)&&!t.startsWith(`|`)&&!t.startsWith("```")})??``);return t.length>180?`${t.slice(0,177)}...`:t},O=e=>{let t=E(e.replace(/```[\s\S]*?```/g,``)).match(/[\u4e00-\u9fff]|[A-Za-z0-9]+/g)?.length??0;return Math.max(2,Math.round(t/320))},k=e=>new Intl.DateTimeFormat(`en`,{month:`short`,day:`numeric`,year:`numeric`}).format(new Date(`${e}T00:00:00Z`)),A=(e,t)=>{let n=e.split(`/`).pop()?.replace(/\.md$/,``);if(!n||n===`index`)return;let{meta:r,body:i}=T(t),a=i.replace(/^#\s+.+\n+/,``);return{slug:n,title:r.title||n,author:r.author||`Team Memoh`,date:k(n),excerpt:D(a),readingMinutes:O(a),body:a}},j=Object.entries(w).map(([e,t])=>A(e,t)).filter(e=>!!e).sort((e,t)=>t.slug.localeCompare(e.slug)),M=e=>j.find(t=>t.slug===e),N={class:`w-full max-w-[1080px] min-h-[calc(100vh-3.5rem)] mx-auto px-4 md:px-8 pt-[112px] md:pt-[148px] pb-[120px] relative z-10`},P={key:0,class:`flex flex-col gap-12`},F={class:`max-w-[760px] flex flex-col gap-5`},I={class:`inline-flex w-fit items-center gap-2 rounded-md border border-border bg-background px-3 py-1.5 text-xs font-medium text-muted-foreground`},L={class:`p-6 md:p-8 flex flex-col gap-6`},R={class:`flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-muted-foreground`},z={class:`inline-flex items-center gap-1.5`},B={class:`inline-flex items-center gap-1.5`},V={class:`inline-flex items-center gap-1.5`},H={class:`flex flex-col gap-3`},U={class:`text-2xl md:text-3xl font-semibold tracking-tight text-foreground leading-tight`},W={class:`text-sm md:text-base text-muted-foreground leading-relaxed`},G={class:`inline-flex items-center gap-2 text-sm font-medium text-foreground`},K={class:`grid grid-cols-1 md:grid-cols-2 gap-4`},q={class:`flex flex-col gap-4`},J={class:`flex items-center justify-between gap-3 text-xs text-muted-foreground`},Y={class:`flex flex-col gap-3`},ae={class:`text-lg font-semibold tracking-tight text-foreground leading-snug`},oe={class:`text-sm text-muted-foreground leading-relaxed`},se={class:`mt-8 inline-flex items-center gap-2 text-sm font-medium text-foreground`},ce={key:1,class:`mx-auto max-w-[820px]`},le={class:`mb-10 flex flex-col gap-5 border-b border-border pb-8`},ue={class:`flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-muted-foreground`},de={class:`inline-flex items-center gap-1.5`},fe={class:`inline-flex items-center gap-1.5`},pe={class:`inline-flex items-center gap-1.5`},me={class:`text-3xl md:text-5xl font-semibold tracking-tight text-foreground leading-tight`},he={class:`text-base md:text-lg text-muted-foreground leading-relaxed`},ge={key:0,class:`rounded-xl border border-border bg-background p-6 text-sm text-muted-foreground`},X=[`innerHTML`],_e={key:2,class:`mt-14 border-t border-border pt-8`},ve={class:`grid grid-cols-1 md:grid-cols-3 gap-4`},ye={class:`mb-2 text-xs text-muted-foreground`},be={class:`text-sm font-medium leading-snug text-foreground`},xe={key:2,class:`mx-auto flex max-w-[640px] flex-col items-center gap-5 py-24 text-center`},Se={class:`rounded-xl border border-border bg-muted p-3 text-muted-foreground`},Z=v(n({__name:`BlogsPage`,setup(n){let _=re(),v=ne(),w=h(()=>{let e=_.params.slug;return typeof e==`string`?e:``}),T=h(()=>w.value.length>0),E=h(()=>w.value?M(decodeURIComponent(w.value)):void 0),D=h(()=>j[0]),O=h(()=>j.filter(e=>e.slug!==E.value?.slug).slice(0,3)),k=f(``),A=f(!1),Z=0,Q=h(()=>E.value?`${E.value.title} | Memoh Blog`:T.value?`Post not found | Memoh Blog`:`Memoh Blog`),$=h(()=>E.value?.excerpt||`Field notes, architecture writeups, and product updates from the Memoh team.`);return te({title:()=>Q.value,description:()=>$.value,ogTitle:()=>Q.value,ogDescription:()=>$.value,ogType:`article`,ogUrl:()=>`https://memoh.ai${_.path}`,twitterCard:`summary_large_image`,twitterTitle:()=>Q.value,twitterDescription:()=>$.value}),a(E,async e=>{let t=++Z;if(k.value=``,!e){A.value=!1;return}A.value=!0;let{renderMarkdown:n}=await ie(async()=>{let{renderMarkdown:e}=await import(`./markdown-BZh-Gc4Y.js`);return{renderMarkdown:e}},[]),r=await n(e.body);t===Z&&(k.value=r,A.value=!1)},{immediate:!0}),(n,a)=>(e(),t(`main`,N,[T.value?E.value?(e(),t(`article`,ce,[r(p(y),{to:`/blogs`,class:`mb-8 inline-flex items-center gap-2 rounded-md px-0 py-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:l(()=>[r(p(ee),{class:`w-4 h-4`}),a[7]||=s(` Back to blogs `,-1)]),_:1}),u(`header`,le,[u(`div`,ue,[u(`span`,de,[r(p(b),{class:`w-3.5 h-3.5`}),s(` `+c(E.value.date),1)]),u(`span`,fe,[r(p(C),{class:`w-3.5 h-3.5`}),s(` `+c(E.value.author),1)]),u(`span`,pe,[r(p(x),{class:`w-3.5 h-3.5`}),s(` `+c(E.value.readingMinutes)+` min read `,1)])]),u(`h1`,me,c(E.value.title),1),u(`p`,he,c(E.value.excerpt),1)]),A.value?(e(),t(`div`,ge,` Rendering code blocks... `)):(e(),t(`div`,{key:1,class:`blog-body`,innerHTML:k.value},null,8,X)),O.value.length?(e(),t(`section`,_e,[a[8]||=u(`h2`,{class:`mb-4 text-lg font-semibold tracking-tight text-foreground`},`More from Memoh`,-1),u(`div`,ve,[(e(!0),t(d,null,i(O.value,t=>(e(),m(p(y),{key:t.slug,to:`/blogs/${t.slug}`,class:`group rounded-xl border border-border bg-background p-4 transition-all hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:l(()=>[u(`p`,ye,c(t.date),1),u(`h3`,be,c(t.title),1)]),_:2},1032,[`to`]))),128))])])):o(``,!0)])):(e(),t(`section`,xe,[u(`div`,Se,[r(p(S),{class:`w-6 h-6`})]),a[9]||=u(`h1`,{class:`text-3xl font-semibold tracking-tight text-foreground`},`Post not found`,-1),a[10]||=u(`p`,{class:`text-muted-foreground`},`The blog post you opened does not exist in this landing site.`,-1),u(`button`,{type:`button`,class:`inline-flex items-center justify-center rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-colors hover:bg-foreground/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`,onClick:a[0]||=e=>p(v).push(`/blogs`)},` Back to blogs `)])):(e(),t(`section`,P,[u(`header`,F,[u(`div`,I,[r(p(S),{class:`w-3.5 h-3.5`}),a[1]||=s(` Memoh Blog `,-1)]),a[2]||=u(`div`,{class:`flex flex-col gap-4`},[u(`h1`,{class:`text-4xl md:text-6xl font-semibold tracking-tight text-foreground leading-[1.05]`},` Notes from the agent platform. `),u(`p`,{class:`text-base md:text-lg text-muted-foreground leading-relaxed max-w-[680px]`},` Product updates, architecture deep dives, and implementation notes from the Memoh team. `)],-1)]),D.value?(e(),m(p(y),{key:0,to:`/blogs/${D.value.slug}`,class:`group grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] overflow-hidden rounded-xl border border-border bg-background transition-all duration-300 hover:-translate-y-1 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:l(()=>[u(`div`,L,[u(`div`,R,[u(`span`,z,[r(p(b),{class:`w-3.5 h-3.5`}),s(` `+c(D.value.date),1)]),u(`span`,B,[r(p(C),{class:`w-3.5 h-3.5`}),s(` `+c(D.value.author),1)]),u(`span`,V,[r(p(x),{class:`w-3.5 h-3.5`}),s(` `+c(D.value.readingMinutes)+` min read `,1)])]),u(`div`,H,[a[3]||=u(`span`,{class:`text-xs font-medium uppercase tracking-[0.16em] text-primary`},`Latest`,-1),u(`h2`,U,c(D.value.title),1),u(`p`,W,c(D.value.excerpt),1)]),u(`span`,G,[a[4]||=s(` Read article `,-1),r(p(g),{class:`w-4 h-4 transition-transform group-hover:translate-x-0.5`})])]),a[5]||=u(`div`,{class:`border-t md:border-t-0 md:border-l border-border bg-muted/35 p-6 md:p-8 flex items-end`},[u(`div`,{class:`w-full font-mono text-xs text-muted-foreground leading-relaxed`},[u(`div`,{class:`mb-4 flex items-center gap-1.5`},[u(`span`,{class:`h-2.5 w-2.5 rounded-full bg-red-400/80`}),u(`span`,{class:`h-2.5 w-2.5 rounded-full bg-yellow-400/80`}),u(`span`,{class:`h-2.5 w-2.5 rounded-full bg-green-400/80`})]),u(`p`,null,`agent.workspace.boot()`),u(`p`,{class:`text-foreground`},`container.isolated = true`),u(`p`,null,`memory.local_first = true`),u(`p`,null,`status = "always-on"`)])],-1)]),_:1},8,[`to`])):o(``,!0),u(`section`,K,[(e(!0),t(d,null,i(p(j).slice(1),t=>(e(),m(p(y),{key:t.slug,to:`/blogs/${t.slug}`,class:`group flex min-h-[260px] flex-col justify-between rounded-xl border border-border bg-background p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:l(()=>[u(`div`,q,[u(`div`,J,[u(`span`,null,c(t.date),1),u(`span`,null,c(t.readingMinutes)+` min`,1)]),u(`div`,Y,[u(`h2`,ae,c(t.title),1),u(`p`,oe,c(t.excerpt),1)])]),u(`span`,se,[a[6]||=s(` Read article `,-1),r(p(g),{class:`w-4 h-4 transition-transform group-hover:translate-x-0.5`})])]),_:2},1032,[`to`]))),128))])]))]))}}),[[`__scopeId`,`data-v-ed316864`]]);export{Z as default};