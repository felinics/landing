import{$ as e,C as t,D as n,O as r,Ot as i,S as a,U as o,V as s,Z as ee,b as c,f as l,g as u,it as d,k as f,n as p,ut as m,w as h,x as g}from"./vue.D51lypTh-vlpxYK8Q.js";import{t as te}from"./arrow-left-C0XrdiBu.js";import{t as _}from"./arrow-right-o5-craQw.js";import{t as v}from"./calendar-days-BcrGb3m1.js";import{c as ne,i as y,l as re,s as b,t as ie}from"./index-C3QBfKk6.js";var x=l(`clock-3`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6h4`,key:`135r8i`}]]),S=l(`file-text`,[[`path`,{d:`M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z`,key:`1oefj6`}],[`path`,{d:`M14 2v5a1 1 0 0 0 1 1h5`,key:`wfsgrz`}],[`path`,{d:`M10 9H8`,key:`b1mrlr`}],[`path`,{d:`M16 13H8`,key:`t4e002`}],[`path`,{d:`M16 17H8`,key:`z1uh3a`}]]),C=l(`user-round`,[[`circle`,{cx:`12`,cy:`8`,r:`5`,key:`1hypcn`}],[`path`,{d:`M20 21a8 8 0 0 0-16 0`,key:`rfgkzh`}]]),w=Object.assign({"../content/blogs/2026-02-16.md":`---
...
`).find(e=>{let t=e.trim();return t&&!t.startsWith(`#`)&&!t.startsWith(`:::`)&&!t.startsWith(`![`)&&!t.startsWith(`- `)&&!t.startsWith(`|`)&&!t.startsWith("```")})??``);return t.length>180?`${t.slice(0,177)}...`:t},O=e=>{let t=E(e.replace(/```[\s\S]*?```/g,``)).match(/[\u4e00-\u9fff]|[A-Za-z0-9]+/g)?.length??0;return Math.max(2,Math.round(t/320))},k=e=>new Intl.DateTimeFormat(`en`,{month:`short`,day:`numeric`,year:`numeric`}).format(new Date(`${e}T00:00:00Z`)),A=(e,t)=>{let n=e.split(`/`).pop()?.replace(/\.md$/,``);if(!n||n===`index`)return;let{meta:r,body:i}=T(t),a=i.replace(/^#\s+.+\n+/,``);return{slug:n,title:r.title||n,author:r.author||`Team Memoh`,date:k(n),excerpt:D(a),readingMinutes:O(a),body:a}},j=Object.entries(w).map(([e,t])=>A(e,t)).filter(e=>!!e).sort((e,t)=>t.slug.localeCompare(e.slug)),M=e=>j.find(t=>t.slug===e),N={class:`w-full max-w-[1080px] min-h-[calc(100vh-3.5rem)] mx-auto px-4 md:px-8 pt-[112px] md:pt-[148px] pb-[120px] relative z-10`},P={key:0,class:`flex flex-col gap-12`},F={class:`max-w-[760px] flex flex-col gap-5`},I={class:`inline-flex w-fit items-center gap-2 rounded-md border border-border bg-background px-3 py-1.5 text-xs font-medium text-muted-foreground`},L={class:`p-6 md:p-8 flex flex-col gap-6`},R={class:`flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-muted-foreground`},z={class:`inline-flex items-center gap-1.5`},B={class:`inline-flex items-center gap-1.5`},V={class:`inline-flex items-center gap-1.5`},H={class:`flex flex-col gap-3`},U={class:`text-2xl md:text-3xl font-semibold tracking-tight text-foreground leading-tight`},W={class:`text-sm md:text-base text-muted-foreground leading-relaxed`},G={class:`inline-flex items-center gap-2 text-sm font-medium text-foreground`},K={class:`grid grid-cols-1 md:grid-cols-2 gap-4`},q={class:`flex flex-col gap-4`},J={class:`flex items-center justify-between gap-3 text-xs text-muted-foreground`},Y={class:`flex flex-col gap-3`},ae={class:`text-lg font-semibold tracking-tight text-foreground leading-snug`},oe={class:`text-sm text-muted-foreground leading-relaxed`},se={class:`mt-8 inline-flex items-center gap-2 text-sm font-medium text-foreground`},ce={key:1,class:`mx-auto max-w-[820px]`},le={class:`mb-10 flex flex-col gap-5 border-b border-border pb-8`},ue={class:`flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-muted-foreground`},de={class:`inline-flex items-center gap-1.5`},fe={class:`inline-flex items-center gap-1.5`},pe={class:`inline-flex items-center gap-1.5`},me={class:`text-3xl md:text-5xl font-semibold tracking-tight text-foreground leading-tight`},he={class:`text-base md:text-lg text-muted-foreground leading-relaxed`},ge={key:0,class:`rounded-xl border border-border bg-background p-6 text-sm text-muted-foreground`},X=[`innerHTML`],_e={key:2,class:`mt-14 border-t border-border pt-8`},ve={class:`grid grid-cols-1 md:grid-cols-3 gap-4`},ye={class:`mb-2 text-xs text-muted-foreground`},be={class:`text-sm font-medium leading-snug text-foreground`},xe={key:2,class:`mx-auto flex max-w-[640px] flex-col items-center gap-5 py-24 text-center`},Se={class:`rounded-xl border border-border bg-muted p-3 text-muted-foreground`},Z=y(f({__name:`BlogsPage`,setup(l){let f=ne(),y=re(),w=c(()=>{let e=f.params.slug;return typeof e==`string`?e:``}),T=c(()=>w.value.length>0),E=c(()=>w.value?M(decodeURIComponent(w.value)):void 0),D=c(()=>j[0]),O=c(()=>j.filter(e=>e.slug!==E.value?.slug).slice(0,3)),k=d(``),A=d(!1),Z=0,Q=c(()=>E.value?`${E.value.title} | Memoh Blog`:T.value?`Post not found | Memoh Blog`:`Memoh Blog`),$=c(()=>E.value?.excerpt||`Field notes, architecture writeups, and product updates from the Memoh team.`);return p({title:()=>Q.value,description:()=>$.value,ogTitle:()=>Q.value,ogDescription:()=>$.value,ogType:`article`,ogUrl:()=>`https://memoh.ai${f.path}`,twitterCard:`summary_large_image`,twitterTitle:()=>Q.value,twitterDescription:()=>$.value}),ee(E,async e=>{let t=++Z;if(k.value=``,!e){A.value=!1;return}A.value=!0;let{renderMarkdown:n}=await ie(async()=>{let{renderMarkdown:e}=await import(`./markdown-B4Y81dHq.js`);return{renderMarkdown:e}},[]),r=await n(e.body);t===Z&&(k.value=r,A.value=!1)},{immediate:!0}),(ee,c)=>(s(),h(`main`,N,[T.value?E.value?(s(),h(`article`,ce,[r(m(b),{to:`/blogs`,class:`mb-8 inline-flex items-center gap-2 rounded-md px-0 py-2 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:e(()=>[r(m(te),{class:`w-4 h-4`}),c[7]||=n(` Back to blogs `,-1)]),_:1}),g(`header`,le,[g(`div`,ue,[g(`span`,de,[r(m(v),{class:`w-3.5 h-3.5`}),n(` `+i(E.value.date),1)]),g(`span`,fe,[r(m(C),{class:`w-3.5 h-3.5`}),n(` `+i(E.value.author),1)]),g(`span`,pe,[r(m(x),{class:`w-3.5 h-3.5`}),n(` `+i(E.value.readingMinutes)+` min read `,1)])]),g(`h1`,me,i(E.value.title),1),g(`p`,he,i(E.value.excerpt),1)]),A.value?(s(),h(`div`,ge,` Rendering code blocks... `)):(s(),h(`div`,{key:1,class:`blog-body`,innerHTML:k.value},null,8,X)),O.value.length?(s(),h(`section`,_e,[c[8]||=g(`h2`,{class:`mb-4 text-lg font-semibold tracking-tight text-foreground`},`More from Memoh`,-1),g(`div`,ve,[(s(!0),h(u,null,o(O.value,t=>(s(),a(m(b),{key:t.slug,to:`/blogs/${t.slug}`,class:`group rounded-xl border border-border bg-background p-4 transition-all hover:-translate-y-0.5 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:e(()=>[g(`p`,ye,i(t.date),1),g(`h3`,be,i(t.title),1)]),_:2},1032,[`to`]))),128))])])):t(``,!0)])):(s(),h(`section`,xe,[g(`div`,Se,[r(m(S),{class:`w-6 h-6`})]),c[9]||=g(`h1`,{class:`text-3xl font-semibold tracking-tight text-foreground`},`Post not found`,-1),c[10]||=g(`p`,{class:`text-muted-foreground`},`The blog post you opened does not exist in this landing site.`,-1),g(`button`,{type:`button`,class:`inline-flex items-center justify-center rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-background transition-colors hover:bg-foreground/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`,onClick:c[0]||=e=>m(y).push(`/blogs`)},` Back to blogs `)])):(s(),h(`section`,P,[g(`header`,F,[g(`div`,I,[r(m(S),{class:`w-3.5 h-3.5`}),c[1]||=n(` Memoh Blog `,-1)]),c[2]||=g(`div`,{class:`flex flex-col gap-4`},[g(`h1`,{class:`text-4xl md:text-6xl font-semibold tracking-tight text-foreground leading-[1.05]`},` Notes from the agent platform. `),g(`p`,{class:`text-base md:text-lg text-muted-foreground leading-relaxed max-w-[680px]`},` Product updates, architecture deep dives, and implementation notes from the Memoh team. `)],-1)]),D.value?(s(),a(m(b),{key:0,to:`/blogs/${D.value.slug}`,class:`group grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] overflow-hidden rounded-xl border border-border bg-background transition-all duration-300 hover:-translate-y-1 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:e(()=>[g(`div`,L,[g(`div`,R,[g(`span`,z,[r(m(v),{class:`w-3.5 h-3.5`}),n(` `+i(D.value.date),1)]),g(`span`,B,[r(m(C),{class:`w-3.5 h-3.5`}),n(` `+i(D.value.author),1)]),g(`span`,V,[r(m(x),{class:`w-3.5 h-3.5`}),n(` `+i(D.value.readingMinutes)+` min read `,1)])]),g(`div`,H,[c[3]||=g(`span`,{class:`text-xs font-medium uppercase tracking-[0.16em] text-primary`},`Latest`,-1),g(`h2`,U,i(D.value.title),1),g(`p`,W,i(D.value.excerpt),1)]),g(`span`,G,[c[4]||=n(` Read article `,-1),r(m(_),{class:`w-4 h-4 transition-transform group-hover:translate-x-0.5`})])]),c[5]||=g(`div`,{class:`border-t md:border-t-0 md:border-l border-border bg-muted/35 p-6 md:p-8 flex items-end`},[g(`div`,{class:`w-full font-mono text-xs text-muted-foreground leading-relaxed`},[g(`div`,{class:`mb-4 flex items-center gap-1.5`},[g(`span`,{class:`h-2.5 w-2.5 rounded-full bg-red-400/80`}),g(`span`,{class:`h-2.5 w-2.5 rounded-full bg-yellow-400/80`}),g(`span`,{class:`h-2.5 w-2.5 rounded-full bg-green-400/80`})]),g(`p`,null,`agent.workspace.boot()`),g(`p`,{class:`text-foreground`},`container.isolated = true`),g(`p`,null,`memory.local_first = true`),g(`p`,null,`status = "always-on"`)])],-1)]),_:1},8,[`to`])):t(``,!0),g(`section`,K,[(s(!0),h(u,null,o(m(j).slice(1),t=>(s(),a(m(b),{key:t.slug,to:`/blogs/${t.slug}`,class:`group flex min-h-[260px] flex-col justify-between rounded-xl border border-border bg-background p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2`},{default:e(()=>[g(`div`,q,[g(`div`,J,[g(`span`,null,i(t.date),1),g(`span`,null,i(t.readingMinutes)+` min`,1)]),g(`div`,Y,[g(`h2`,ae,i(t.title),1),g(`p`,oe,i(t.excerpt),1)])]),g(`span`,se,[c[6]||=n(` Read article `,-1),r(m(_),{class:`w-4 h-4 transition-transform group-hover:translate-x-0.5`})])]),_:2},1032,[`to`]))),128))])]))]))}}),[[`__scopeId`,`data-v-ed316864`]]);export{Z as default};